...
public class testaGerenciaClasses {
	...
	public static void main(String[] args) throws Exception {
		...
		ClassesGerenciaFacade classesGerenciaFacade = new ClassesGerenciaFacade();

		// Instancie a fachada do EasyAccept
		EasyAcceptFacade eaFacade = new EasyAcceptFacade(classesGerenciaFacade,
				files);
